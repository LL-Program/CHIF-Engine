...
class BaseModel:
    def __init__(self, app, vao_name, tex_id, pos=(0, 0, 0), rot=(0, 0, 0), scale=(1, 1, 1)):
        ...
        self.gravity = glm.vec3(0, -0.0000003, 0)  # Gravity force vector
    ...
    def update_physics(self, delta_time):
        if self.app.physics:  # Global physics toggle
...
class ExtendedBaseModel(BaseModel):
    ...
    def update(self):
        ...
        self.m_model = self.get_model_matrix()  # Update model matrix after physics
