...
class VBO:
    def __init__(self, ctx):
        self.vbos = {}
        self.ctx = ctx
        # Initialize VBOs once, reuse if possible
...
class BaseVBO:
    ...
    def get_vbo(self):
        ...
        # Create buffer directly with vertex data
...
class OBJVBO(BaseVBO):
    ...
    def get_vertex_data(self):
        # Optimize OBJ loading
        objs = pywavefront.Wavefront('objects/Eiffel Tower/Eiffel Tower.obj', cache=True, parse=True)
