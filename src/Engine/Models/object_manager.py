...
class ObjectManager:
    def __init__(self,engine):
        ...
        self.load_object('astronaut','objects/Surface/terrain.obj','objects/Surface/mars.png')
    def load_object(self,name,object,texture,pos= (0,0,0),scale = (1,1,1),rot=(180,0,0)):
