...
namespace chif::lua::primitive
{
	...
	public:
		...
		Ray_BindLua(const chif::primitive::Ray& ray) : ray(ray) {}
	...
	public:
		...
		AABB_BindLua(const chif::primitive::AABB& aabb) : aabb(aabb) {}
	...
	public:
		...
		Sphere_BindLua(const chif::primitive::Sphere& sphere) : sphere(sphere) {}
	...
	public:
		...
		Capsule_BindLua(const chif::primitive::Capsule& capsule) : capsule(capsule) {}
