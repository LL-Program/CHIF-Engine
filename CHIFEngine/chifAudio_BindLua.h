...
namespace chif::lua
{
	...
	public:
		...
		Sound_BindLua(const chif::audio::Sound& sound)
		{
			soundResource.SetSound(sound);
		}
		Sound_BindLua(const chif::Resource resource)
		{
	...
	public:
		...
		SoundInstance_BindLua(const chif::audio::SoundInstance& instance)
		{
	...
	{
	public:
		chif::audio::SoundInstance3D soundinstance3D;
		...
		SoundInstance3D_BindLua(const chif::audio::SoundInstance3D& soundinstance3D) : soundinstance3D(soundinstance3D) {}
