...
namespace chif::fftgenerator
{
	...
	struct CSFFT512x512_Plan
	{
		...
		chif::graphics::GPUBuffer pRadix008A_CB[6];

		chif::graphics::GPUBuffer pBuffer_Tmp;
...
#define FFT_INVERSE 1
	...
	void LoadShaders()
	{
		chif::renderer::LoadShader(ShaderStage::CS, radix008A_CS, "fft_512x512_c2c_CS.cso");
		chif::renderer::LoadShader(ShaderStage::CS, radix008A_CS2, "fft_512x512_c2c_v2_CS.cso");
	}
