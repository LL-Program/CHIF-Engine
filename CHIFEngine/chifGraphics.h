...
namespace chif::graphics
{
	...
	struct RaytracingAccelerationStructureDesc
	{
		...
		struct BottomLevel
		{
			...
			chif::vector<Geometry> geometries;
		} bottom_level;
	...
	{
		chif::vector<ShaderLibrary> shader_libraries;
		chif::vector<ShaderHitGroup> hit_groups;
	...
	constexpr const char* GetFormatString(Format format)
	{
		switch (format)
		{
		case chif::graphics::Format::UNKNOWN:
			return "UNKNOWN";
		...
		case chif::graphics::Format::R32G32_SINT:
			return "R32G32_SINT";
		case chif::graphics::Format::D32_FLOAT_S8X24_UINT:
		...
		case chif::graphics::Format::R32_SINT:
			return "R32_SINT";
		case chif::graphics::Format::D24_UNORM_S8_UINT:
		...
		case chif::graphics::Format::NV12:
			return "NV12";
		default:
			return "";
		}
	...
	struct RenderPassDesc
	{
		...
		chif::vector<RenderPassAttachment> attachments;
	};
	// Deprecated, kept for back-compat:
	struct RenderPass
	{
...
template<>
struct enable_bitmask_operators<chif::graphics::ColorWrite> {
	static const bool enable = true;
};
template<>
struct enable_bitmask_operators<chif::graphics::BindFlag> {
	static const bool enable = true;
};
template<>
struct enable_bitmask_operators<chif::graphics::ResourceMiscFlag> {
	static const bool enable = true;
};
template<>
struct enable_bitmask_operators<chif::graphics::GraphicsDeviceCapability> {
	static const bool enable = true;
};
template<>
struct enable_bitmask_operators<chif::graphics::ResourceState> {
	static const bool enable = true;
};
template<>
struct enable_bitmask_operators<chif::graphics::RenderPassDesc::Flags> {
	static const bool enable = true;
};
template<>
struct enable_bitmask_operators<chif::graphics::RenderPassFlags> {
	static const bool enable = true;
};
