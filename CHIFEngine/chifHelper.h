...
namespace chif::helper
{
	...
	bool FileRead(const std::string& fileName, chif::vector<uint8_t>& data, size_t max_read = ~0ull, size_t offset = 0);

#if CHIF_VECTOR_TYPE
	// This version is provided if std::vector != chif::vector
	...
	struct FileDialogParams
	{
		...
		chif::vector<std::string> extensions;
	};
