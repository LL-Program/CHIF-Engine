...
namespace chif::lua::scene
{
	...
	{
	private:
		std::unique_ptr<chif::scene::Scene> owning; // GetScene() is too slow if scene object is always constructed
	public:
		chif::scene::Scene* scene = nullptr;
		...
		Scene_BindLua(chif::scene::Scene* scene) :scene(scene) {}
		Scene_BindLua(lua_State* L) : owning(std::make_unique<chif::scene::Scene>()), scene(owning.get()) {}
	...
	{
	private:
		chif::scene::NameComponent owning;
	public:
		chif::scene::NameComponent* component = nullptr;
		...
		NameComponent_BindLua(chif::scene::NameComponent* component) :component(component) {}
	...
	{
	private:
		chif::scene::LayerComponent owning;
	public:
		chif::scene::LayerComponent* component = nullptr;
		...
		LayerComponent_BindLua(chif::scene::LayerComponent* component) :component(component) {}
	...
	{
	private:
		chif::scene::TransformComponent owning;
	public:
		chif::scene::TransformComponent* component = nullptr;
		...
		TransformComponent_BindLua(chif::scene::TransformComponent* component) :component(component)
		{
			BuildBindings();
		}
	...
	{
	private:
		chif::scene::CameraComponent owning;
	public:
		chif::scene::CameraComponent* component = nullptr;
		...
		CameraComponent_BindLua(chif::scene::CameraComponent* component) :component(component) {}
	...
	{
	private:
		chif::scene::AnimationComponent owning;
	public:
		chif::scene::AnimationComponent* component = nullptr;
		...
		AnimationComponent_BindLua(chif::scene::AnimationComponent* component) :component(component) {}
	...
	{
	private:
		chif::scene::MaterialComponent owning;
	public:
		chif::scene::MaterialComponent* component = nullptr;
		...
		MaterialComponent_BindLua(chif::scene::MaterialComponent* component) :component(component)
		{
			BuildBindings();
		}
	...
	{
	private:
		chif::scene::MeshComponent owning;
	public:
		chif::scene::MeshComponent* component = nullptr;
		...
		MeshComponent_BindLua(chif::scene::MeshComponent* component) :component(component)
		{
			BuildBindings();
		}
	...
	{
	private:
		chif::EmittedParticleSystem owning;
	public:
		chif::EmittedParticleSystem* component = nullptr;
		...
		EmitterComponent_BindLua(chif::EmittedParticleSystem* component) :component(component)
		{
			BuildBindings();
		}
	...
	{
	private:
		chif::HairParticleSystem owning;
	public:
		chif::HairParticleSystem* component = nullptr;
	...
	{
	private:
		chif::scene::LightComponent owning;
	public:
		chif::scene::LightComponent* component = nullptr;
		...
		LightComponent_BindLua(chif::scene::LightComponent* component) :component(component) {}
	...
	{
	private:
		chif::scene::ObjectComponent owning;
	public:
		chif::scene::ObjectComponent* component = nullptr;
		...
		ObjectComponent_BindLua(chif::scene::ObjectComponent* component) :component(component) {}
	...
	{
	private:
		chif::scene::InverseKinematicsComponent owning;
	public:
		chif::scene::InverseKinematicsComponent* component = nullptr;
		...
		InverseKinematicsComponent_BindLua(chif::scene::InverseKinematicsComponent* component) :component(component) {}
	...
	{
	private:
		chif::scene::SpringComponent owning;
	public:
		chif::scene::SpringComponent* component = nullptr;
		...
		SpringComponent_BindLua(chif::scene::SpringComponent* component) :component(component)
		{
			BuildBindings();
		}
	...
	{
	private:
		chif::scene::ScriptComponent owning;
	public:
		chif::scene::ScriptComponent* component = nullptr;
		...
		ScriptComponent_BindLua(chif::scene::ScriptComponent* component) :component(component) {}
	...
	{
	private:
		chif::scene::RigidBodyPhysicsComponent owning;
	public:
		chif::scene::RigidBodyPhysicsComponent* component = nullptr;
		...
		RigidBodyPhysicsComponent_BindLua(chif::scene::RigidBodyPhysicsComponent* component) :component(component)
		{
			BuildBindings();
		}
	...
	{
	private:
		chif::scene::SoftBodyPhysicsComponent owning;
	public:
		chif::scene::SoftBodyPhysicsComponent* component = nullptr;
		...
		inline void BuildBindings()
		{
			Mass = chif::lua::FloatProperty(&component->mass);
			Friction = chif::lua::FloatProperty(&component->friction);
			Restitution = chif::lua::FloatProperty(&component->restitution);
			VertexRadius = chif::lua::FloatProperty(&component->vertex_radius);
		}

		SoftBodyPhysicsComponent_BindLua(chif::scene::SoftBodyPhysicsComponent* component) :component(component)
		{
			BuildBindings();
		}
		...
		chif::lua::FloatProperty Mass;
		chif::lua::FloatProperty Friction;
		chif::lua::FloatProperty Restitution;
		chif::lua::FloatProperty VertexRadius;
	...
	{
	private:
		chif::scene::ForceFieldComponent owning;
	public:
		chif::scene::ForceFieldComponent* component = nullptr;
		...
		ForceFieldComponent_BindLua(chif::scene::ForceFieldComponent* component) :component(component)
		{
			BuildBindings();
		}
	...
	{
	private:
		chif::Ocean::OceanParameters owning;
	public:
		chif::Ocean::OceanParameters* parameter = nullptr;
		...
		Weather_OceanParams_BindLua(chif::Ocean::OceanParameters* parameter) :parameter(parameter)
		{
			BuildBindings();
		}
	...
	{
		chif::Ocean::OceanParameters* data = nullptr;
		Weather_OceanParams_Property(){}
		Weather_OceanParams_Property(chif::Ocean::OceanParameters* data) :data(data){}
		int Get(lua_State* L);
		int Set(lua_State* L);
	};
	...
	{
	private:
		chif::scene::WeatherComponent owning;
	public:
		chif::scene::WeatherComponent* component = nullptr;
		...
		WeatherComponent_BindLua(chif::scene::WeatherComponent* component) :component(component)
		{
			BuildBindings();
		}
	...
	{
	private:
		chif::scene::SoundComponent owning;
	public:
		chif::scene::SoundComponent* component = nullptr;
		...
		SoundComponent_BindLua(chif::scene::SoundComponent* component) :component(component)
		{
			BuildBindings();
		}
	...
	{
	private:
		chif::scene::ColliderComponent owning;
	public:
		chif::scene::ColliderComponent* component = nullptr;
		...
		ColliderComponent_BindLua(chif::scene::ColliderComponent* component) :component(component)
		{
			BuildBindings();
		}
	...
	{
	private:
		chif::scene::ExpressionComponent owning;
	public:
		chif::scene::ExpressionComponent* component = nullptr;
		...
		ExpressionComponent_BindLua(chif::scene::ExpressionComponent* component) :component(component) {}
	...
	{
	private:
		chif::scene::HumanoidComponent owning;
	public:
		chif::scene::HumanoidComponent* component = nullptr;
		...
		HumanoidComponent_BindLua(chif::scene::HumanoidComponent* component) :component(component) {}
	...
	{
	private:
		chif::scene::DecalComponent owning;
	public:
		chif::scene::DecalComponent* component = nullptr;
		...
		DecalComponent_BindLua(chif::scene::DecalComponent* component) :component(component) {}
	...
	{
	private:
		chif::scene::MetadataComponent owning;
	public:
		chif::scene::MetadataComponent* component = nullptr;
		...
		MetadataComponent_BindLua(chif::scene::MetadataComponent* component) :component(component) {}
	...
	{
	private:
		chif::scene::CharacterComponent owning;
	public:
		chif::scene::CharacterComponent* component = nullptr;
		...
		CharacterComponent_BindLua(chif::scene::CharacterComponent* component) :component(component) {}
