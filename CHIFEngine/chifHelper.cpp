...
namespace chif::helper
{
	...
	std::string screenshot(const chif::graphics::SwapChain& swapchain, const std::string& name)
	{
		...
		bool result = saveTextureToFile(chif::graphics::GetDevice()->GetBackBuffer(&swapchain), filename);
		assert(result);
	...
	bool saveTextureToMemory(const chif::graphics::Texture& texture, chif::vector<uint8_t>& texturedata)
	{
	...
	bool saveTextureToMemoryFile(const chif::graphics::Texture& texture, const std::string& fileExtension, chif::vector<uint8_t>& filedata)
	{
		using namespace chif::graphics;
		TextureDesc desc = texture.GetDesc();
		chif::vector<uint8_t> texturedata;
	...
	bool saveTextureToMemoryFile(const chif::vector<uint8_t>& texturedata, const chif::graphics::TextureDesc& desc, const std::string& fileExtension, chif::vector<uint8_t>& filedata)
	{
		using namespace chif::graphics;
		const uint32_t data_stride = GetFormatStride(desc.format);

		std::string extension = chif::helper::toUpper(fileExtension);
		...
		if (extension.compare("DDS") == 0)
		{
			...
			switch (desc.format)
			{
			case chif::graphics::Format::R32G32B32A32_FLOAT:
				dds_format = dds::DXGI_FORMAT_R32G32B32A32_FLOAT;
				break;
			case chif::graphics::Format::R32G32B32A32_UINT:
				dds_format = dds::DXGI_FORMAT_R32G32B32A32_UINT;
				break;
			case chif::graphics::Format::R32G32B32A32_SINT:
				dds_format = dds::DXGI_FORMAT_R32G32B32A32_SINT;
				break;
			case chif::graphics::Format::R32G32B32_FLOAT:
				dds_format = dds::DXGI_FORMAT_R32G32B32_FLOAT;
				break;
			case chif::graphics::Format::R32G32B32_UINT:
				dds_format = dds::DXGI_FORMAT_R32G32B32_UINT;
				break;
			case chif::graphics::Format::R32G32B32_SINT:
				dds_format = dds::DXGI_FORMAT_R32G32B32_SINT;
				break;
			case chif::graphics::Format::R16G16B16A16_FLOAT:
				dds_format = dds::DXGI_FORMAT_R16G16B16A16_FLOAT;
				break;
			case chif::graphics::Format::R16G16B16A16_UNORM:
				dds_format = dds::DXGI_FORMAT_R16G16B16A16_UNORM;
				break;
			case chif::graphics::Format::R16G16B16A16_UINT:
				dds_format = dds::DXGI_FORMAT_R16G16B16A16_UINT;
				break;
			case chif::graphics::Format::R16G16B16A16_SNORM:
				dds_format = dds::DXGI_FORMAT_R16G16B16A16_SNORM;
				break;
			case chif::graphics::Format::R16G16B16A16_SINT:
				dds_format = dds::DXGI_FORMAT_R16G16B16A16_SINT;
				break;
			case chif::graphics::Format::R32G32_FLOAT:
				dds_format = dds::DXGI_FORMAT_R32G32_FLOAT;
				break;
			case chif::graphics::Format::R32G32_UINT:
				dds_format = dds::DXGI_FORMAT_R32G32_UINT;
				break;
			case chif::graphics::Format::R32G32_SINT:
				dds_format = dds::DXGI_FORMAT_R32G32_SINT;
				break;
			case chif::graphics::Format::R10G10B10A2_UNORM:
				dds_format = dds::DXGI_FORMAT_R10G10B10A2_UNORM;
				break;
			case chif::graphics::Format::R10G10B10A2_UINT:
				dds_format = dds::DXGI_FORMAT_R10G10B10A2_UINT;
				break;
			case chif::graphics::Format::R11G11B10_FLOAT:
				dds_format = dds::DXGI_FORMAT_R11G11B10_FLOAT;
				break;
			case chif::graphics::Format::R8G8B8A8_UNORM:
				dds_format = dds::DXGI_FORMAT_R8G8B8A8_UNORM;
				break;
			case chif::graphics::Format::R8G8B8A8_UNORM_SRGB:
				dds_format = dds::DXGI_FORMAT_R8G8B8A8_UNORM_SRGB;
				break;
			case chif::graphics::Format::R8G8B8A8_UINT:
				dds_format = dds::DXGI_FORMAT_R8G8B8A8_UINT;
				break;
			case chif::graphics::Format::R8G8B8A8_SNORM:
				dds_format = dds::DXGI_FORMAT_R8G8B8A8_SNORM;
				break;
			case chif::graphics::Format::R8G8B8A8_SINT:
				dds_format = dds::DXGI_FORMAT_R8G8B8A8_SINT;
				break;
			case chif::graphics::Format::B8G8R8A8_UNORM:
				dds_format = dds::DXGI_FORMAT_B8G8R8A8_UNORM;
				break;
			case chif::graphics::Format::B8G8R8A8_UNORM_SRGB:
				dds_format = dds::DXGI_FORMAT_R16G16_SINT;
				break;
			case chif::graphics::Format::R16G16_FLOAT:
				dds_format = dds::DXGI_FORMAT_R16G16_FLOAT;
				break;
			case chif::graphics::Format::R16G16_UNORM:
				dds_format = dds::DXGI_FORMAT_R16G16_UNORM;
				break;
			case chif::graphics::Format::R16G16_UINT:
				dds_format = dds::DXGI_FORMAT_R16G16_UINT;
				break;
			case chif::graphics::Format::R16G16_SNORM:
				dds_format = dds::DXGI_FORMAT_R16G16_SNORM;
				break;
			case chif::graphics::Format::R16G16_SINT:
				dds_format = dds::DXGI_FORMAT_R16G16_SINT;
				break;
			case chif::graphics::Format::D32_FLOAT:
			case chif::graphics::Format::R32_FLOAT:
				dds_format = dds::DXGI_FORMAT_R32_FLOAT;
				break;
			case chif::graphics::Format::R32_UINT:
				dds_format = dds::DXGI_FORMAT_R32_UINT;
				break;
			case chif::graphics::Format::R32_SINT:
				dds_format = dds::DXGI_FORMAT_R32_SINT;
				break;
			case chif::graphics::Format::R9G9B9E5_SHAREDEXP:
				dds_format = dds::DXGI_FORMAT_R9G9B9E5_SHAREDEXP;
				break;
			case chif::graphics::Format::R8G8_UNORM:
				dds_format = dds::DXGI_FORMAT_R8G8_UNORM;
				break;
			case chif::graphics::Format::R8G8_UINT:
				dds_format = dds::DXGI_FORMAT_R8G8_UINT;
				break;
			case chif::graphics::Format::R8G8_SNORM:
				dds_format = dds::DXGI_FORMAT_R8G8_SNORM;
				break;
			case chif::graphics::Format::R8G8_SINT:
				dds_format = dds::DXGI_FORMAT_R8G8_SINT;
				break;
			case chif::graphics::Format::R16_FLOAT:
				dds_format = dds::DXGI_FORMAT_R16_FLOAT;
				break;
			case chif::graphics::Format::D16_UNORM:
			case chif::graphics::Format::R16_UNORM:
				dds_format = dds::DXGI_FORMAT_R16_UNORM;
				break;
			case chif::graphics::Format::R16_UINT:
				dds_format = dds::DXGI_FORMAT_R16_UINT;
				break;
			case chif::graphics::Format::R16_SNORM:
				dds_format = dds::DXGI_FORMAT_R16_SNORM;
				break;
			case chif::graphics::Format::R16_SINT:
				dds_format = dds::DXGI_FORMAT_R16_SINT;
				break;
			case chif::graphics::Format::R8_UNORM:
				dds_format = dds::DXGI_FORMAT_R8_UNORM;
				break;
			case chif::graphics::Format::R8_UINT:
				dds_format = dds::DXGI_FORMAT_R8_UINT;
				break;
			case chif::graphics::Format::R8_SNORM:
				dds_format = dds::DXGI_FORMAT_R8_SNORM;
				break;
			case chif::graphics::Format::R8_SINT:
				dds_format = dds::DXGI_FORMAT_R8_SINT;
				break;
			case chif::graphics::Format::BC1_UNORM:
				dds_format = dds::DXGI_FORMAT_BC1_UNORM;
				break;
			case chif::graphics::Format::BC1_UNORM_SRGB:
				dds_format = dds::DXGI_FORMAT_BC1_UNORM_SRGB;
				break;
			case chif::graphics::Format::BC2_UNORM:
				dds_format = dds::DXGI_FORMAT_BC2_UNORM;
				break;
			case chif::graphics::Format::BC2_UNORM_SRGB:
				dds_format = dds::DXGI_FORMAT_BC2_UNORM_SRGB;
				break;
			case chif::graphics::Format::BC3_UNORM:
				dds_format = dds::DXGI_FORMAT_BC3_UNORM;
				break;
			case chif::graphics::Format::BC3_UNORM_SRGB:
				dds_format = dds::DXGI_FORMAT_BC3_UNORM_SRGB;
				break;
			case chif::graphics::Format::BC4_UNORM:
				dds_format = dds::DXGI_FORMAT_BC4_UNORM;
				break;
			case chif::graphics::Format::BC4_SNORM:
				dds_format = dds::DXGI_FORMAT_BC4_SNORM;
				break;
			case chif::graphics::Format::BC5_UNORM:
				dds_format = dds::DXGI_FORMAT_BC5_UNORM;
				break;
			case chif::graphics::Format::BC5_SNORM:
				dds_format = dds::DXGI_FORMAT_BC5_SNORM;
				break;
			case chif::graphics::Format::BC6H_UF16:
				dds_format = dds::DXGI_FORMAT_BC6H_UF16;
				break;
			case chif::graphics::Format::BC6H_SF16:
				dds_format = dds::DXGI_FORMAT_BC6H_SF16;
				break;
			case chif::graphics::Format::BC7_UNORM:
				dds_format = dds::DXGI_FORMAT_BC7_UNORM;
				break;
			case chif::graphics::Format::BC7_UNORM_SRGB:
		...
		if (is_png)
		{
			if (desc.format == Format::R16_UNORM || desc.format == Format::R16_UINT)
			{
				...
				chif::vector<uint8_t> src_bigendian = texturedata;
			...
			if (desc.format == Format::R16G16_UNORM || desc.format == Format::R16G16_UINT)
			{
				...
				chif::vector<chif::Color16> dest_rgba(desc.width * desc.height);
				for (uint32_t i = 0; i < desc.width * desc.height; ++i)
				{
					uint32_t rg = src_rg[i];
					chif::Color16& rgba = dest_rgba[i];
					uint16_t r = rg & 0xFFFF;
					r = (r >> 8) | ((r & 0xFF) << 8); // little endian to big endian
					uint16_t g = (rg >> 16u) & 0xFFFF;
					g = (g >> 8) | ((g & 0xFF) << 8); // little endian to big endian
					rgba = chif::Color16(r, g, 0xFFFF, 0xFFFF);
				}
			...
			if (desc.format == Format::R16G16B16A16_UNORM || desc.format == Format::R16G16B16A16_UINT)
			{
				// Specialized handling for 16-bit PNG:
				chif::vector<uint8_t> src_bigendian = texturedata;
				chif::Color16* dest = (chif::Color16*)src_bigendian.data();
				for (uint32_t i = 0; i < desc.width * desc.height; ++i)
				{
					chif::Color16 rgba = dest[i];
		...
		{
			// This will be converted first to rgba8 before saving to common format:
			chif::Color16* dataSrc = (chif::Color16*)texturedata.data();
			chif::Color* data32 = (chif::Color*)texturedata.data();

			for (uint32_t i = 0; i < data_count; ++i)
			{
				chif::Color16 pixel16 = dataSrc[i];
				data32[i] = chif::Color::fromFloat4(pixel16.toFloat4());
			}
		}
		...
		if (basis || ktx2)
		{
			...
			if (compressor.init(params))
			{
				...
				{
					chif::backlog::post("basisu::basis_compressor::process() failure!", chif::backlog::LogLevel::Error);
					assert(0);
				}
			}
			return false;
		...
		stbi_write_func* func = [](void* context, void* data, int size) {
			chif::vector<uint8_t>& filedata = *(chif::vector<uint8_t>*)context;
	...
	bool saveTextureToFile(const chif::graphics::Texture& texture, const std::string& fileName)
	{
		using namespace chif::graphics;
		TextureDesc desc = texture.GetDesc();
	...
	bool saveTextureToFile(const chif::vector<uint8_t>& texturedata, const chif::graphics::TextureDesc& desc, const std::string& fileName)
	{
		using namespace chif::graphics;

		std::string ext = GetExtensionFromFileName(fileName);
		chif::vector<uint8_t> filedata;
...
#define ToNativeString(x) (x)
	...
	bool FileRead_Impl(const std::string& fileName, vector_interface<uint8_t, std::allocator<uint8_t>>& data, size_t max_read, size_t offset)
	{
		...
		chif::backlog::post("File not found: " + fileName, chif::backlog::LogLevel::Warning);
		return false;
	}
	bool FileRead(const std::string& fileName, chif::vector<uint8_t>& data, size_t max_read, size_t offset)
	{
	...
	void GetFileNamesInDirectory(const std::string& directory, std::function<void(std::string fileName)> onSuccess, const std::string& filter_extension)
	{
		...
		for (const auto& entry : std::filesystem::directory_iterator(directory_path))
		{
			...
			if (filter_extension.empty() || chif::helper::toUpper(chif::helper::GetExtensionFromFileName(filename)).compare(chif::helper::toUpper(filter_extension)) == 0)
			{
	...
	void OpenUrl(const std::string& url)
	{
		...
		chif::backlog::post("chif::helper::OpenUrl(" + url + ") returned status: " + std::to_string(status));
		return;
#endif // PLATFORM_WINDOWS_DESKTOP
		...
		chif::backlog::post("chif::helper::OpenUrl(" + url + "): not implemented for this operating system!", chif::backlog::LogLevel::Warning);
	}
	...
	MemoryUsage GetMemoryUsage()
	{
		...
		// swapped out memory
#elif defined(PLATFORM_PS5)
		chif::graphics::GraphicsDevice::MemoryUsage gpumem = chif::graphics::GetDevice()->GetMemoryUsage();
