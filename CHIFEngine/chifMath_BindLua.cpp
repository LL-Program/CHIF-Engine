...
namespace chif::lua
{
	...
	Vector_BindLua::Vector_BindLua(lua_State* L)
	{
		...
		if (argc > 0)
		{
			data.x = chif::lua::SGetFloat(L, 1);
			if (argc > 1)
			{
				data.y = chif::lua::SGetFloat(L, 2);
				if (argc > 2)
				{
					data.z = chif::lua::SGetFloat(L, 3);
					if (argc > 3)
					{
						data.w = chif::lua::SGetFloat(L, 4);
					}
				}
			}
		}
	...
	{
		chif::lua::SSetFloat(L, data.x);
		return 1;
	}
	int Vector_BindLua::GetY(lua_State* L)
	{
		chif::lua::SSetFloat(L, data.y);
		return 1;
	}
	int Vector_BindLua::GetZ(lua_State* L)
	{
		chif::lua::SSetFloat(L, data.z);
		return 1;
	}
	int Vector_BindLua::GetW(lua_State* L)
	{
		chif::lua::SSetFloat(L, data.w);
		return 1;
	}
	...
	int Vector_BindLua::SetX(lua_State* L)
	{
		...
		if (argc > 0)
		{
			...
			chif::lua::SError(L, "SetX(float value) not enough arguments!");
		return 0;
	}
	int Vector_BindLua::SetY(lua_State* L)
	{
		...
		if (argc > 0)
		{
			data.y = chif::lua::SGetFloat(L, 1);
		}
		else
			chif::lua::SError(L, "SetY(float value) not enough arguments!");
		return 0;
	}
	int Vector_BindLua::SetZ(lua_State* L)
	{
		...
		if (argc > 0)
		{
			data.z = chif::lua::SGetFloat(L, 1);
		}
		else
			chif::lua::SError(L, "SetZ(float value) not enough arguments!");
		return 0;
	}
	int Vector_BindLua::SetW(lua_State* L)
	{
		...
		if (argc > 0)
		{
			data.w = chif::lua::SGetFloat(L, 1);
		}
		else
			chif::lua::SError(L, "SetW(float value) not enough arguments!");
		return 0;
	}
	...
	int Vector_BindLua::Transform(lua_State* L)
	{
		...
		if (argc > 1)
		{
			...
			chif::lua::SError(L, "Transform(Vector vec, Matrix matrix) argument types mismatch!");
		}
		chif::lua::SError(L, "Transform(Vector vec, Matrix matrix) not enough arguments!");
		return 0;
	}
	int Vector_BindLua::TransformNormal(lua_State* L)
	{
		...
		if (argc > 1)
		{
			...
			if (vec && mat)
			{
				...
				chif::lua::SError(L, "TransformNormal(Vector vec, Matrix matrix) argument types mismatch!");
		}
		chif::lua::SError(L, "TransformNormal(Vector vec, Matrix matrix) not enough arguments!");
		return 0;
	}
	int Vector_BindLua::TransformCoord(lua_State* L)
	{
		...
		if (argc > 1)
		{
			...
			if (vec && mat)
			{
				...
				chif::lua::SError(L, "TransformCoord(Vector vec, Matrix matrix) argument types mismatch!");
		}
		chif::lua::SError(L, "TransformCoord(Vector vec, Matrix matrix) not enough arguments!");
		return 0;
	}
	int Vector_BindLua::Length(lua_State* L)
	{
		...
		if (argc > 0)
		{
			...
			if (vec)
			{
				...
				chif::lua::SSetFloat(L, XMVectorGetX(XMVector3Length(XMLoadFloat4(&vec->data))));
				return 1;
			}
		}
		chif::lua::SSetFloat(L, XMVectorGetX(XMVector3Length(XMLoadFloat4(&data))));
		return 1;
	}
	int Vector_BindLua::LengthSquared(lua_State* L)
	{
		...
		if (argc > 0)
		{
			...
			{
				// Additional syntax support for static access
				chif::lua::SSetFloat(L, XMVectorGetX(XMVector3LengthSq(XMLoadFloat4(&vec->data))));
				return 1;
			}
		}
		chif::lua::SSetFloat(L, XMVectorGetX(XMVector3LengthSq(XMLoadFloat4(&data))));
		return 1;
	}
	int Vector_BindLua::Distance(lua_State* L)
	{
		...
		if (argc > 1)
		{
			...
			if (v1 == nullptr)
			{
				chif::lua::SError(L, "Distance(Vector v1, v2) first argument is not a Vector!");
				return 0;
			}
			Vector_BindLua* v2 = Luna<Vector_BindLua>::lightcheck(L, 2);
			if (v2 == nullptr)
			{
				chif::lua::SError(L, "Distance(Vector v1, v2) second argument is not a Vector!");
				return 0;
			}
			chif::lua::SSetFloat(L, XMVectorGetX(XMVector3Length(XMLoadFloat4(&v1->data) - XMLoadFloat4(&v2->data))));
			return 1;
		}
		chif::lua::SError(L, "Distance(Vector v1, v2) not enough arguments!");
		return 0;
	}
	int Vector_BindLua::DistanceSquared(lua_State* L)
	{
		...
		if (argc > 1)
		{
			...
			if (v1 == nullptr)
			{
				chif::lua::SError(L, "DistanceSquared(Vector v1, v2) first argument is not a Vector!");
				return 0;
			}
			Vector_BindLua* v2 = Luna<Vector_BindLua>::lightcheck(L, 2);
			if (v2 == nullptr)
			{
				chif::lua::SError(L, "DistanceSquared(Vector v1, v2) second argument is not a Vector!");
				return 0;
			}
			chif::lua::SSetFloat(L, XMVectorGetX(XMVector3LengthSq(XMLoadFloat4(&v1->data) - XMLoadFloat4(&v2->data))));
			return 1;
		}
		chif::lua::SError(L, "DistanceSquared(Vector v1, v2) not enough arguments!");
		return 0;
	}
	...
	int Vector_BindLua::Clamp(lua_State* L)
	{
		...
		if (argc > 2)
		{
			...
			if (vec)
			{
				float a = chif::lua::SGetFloat(L, 2);
				float b = chif::lua::SGetFloat(L, 3);
		...
		if (argc > 1)
		{
			float a = chif::lua::SGetFloat(L, 1);
			float b = chif::lua::SGetFloat(L, 2);
			Luna<Vector_BindLua>::push(L, XMVectorClamp(XMLoadFloat4(&data), XMVectorReplicate(a), XMVectorReplicate(b)));
			return 1;
		}
		chif::lua::SError(L, "Clamp(float min,max) not enough arguments!");
		return 0;
	}
	...
	int Vector_BindLua::Dot(lua_State* L)
	{
		...
		if (argc > 1)
		{
			...
			if (v1 && v2)
			{
				chif::lua::SSetFloat(L, XMVectorGetX(XMVector3Dot(XMLoadFloat4(&v1->data), XMLoadFloat4(&v2->data))));
				return 1;
			}
		}
		chif::lua::SError(L, "Dot(Vector v1,v2) not enough arguments!");
		return 0;
	}
	int Vector_BindLua::Cross(lua_State* L)
	{
		...
		chif::lua::SError(L, "Cross(Vector v1,v2) not enough arguments!");
		return 0;
	}
	int Vector_BindLua::Multiply(lua_State* L)
	{
		...
		if (argc > 1)
		{
			...
			{
				Luna<Vector_BindLua>::push(L, XMLoadFloat4(&v1->data) * chif::lua::SGetFloat(L, 2));
				return 1;
			}
			else if (v2)
			{
				Luna<Vector_BindLua>::push(L, chif::lua::SGetFloat(L, 1) * XMLoadFloat4(&v2->data));
				return 1;
			}
		}
		chif::lua::SError(L, "Multiply(Vector v1,v2) not enough arguments!");
		return 0;
	}
	int Vector_BindLua::Add(lua_State* L)
	{
		...
		chif::lua::SError(L, "Add(Vector v1,v2) not enough arguments!");
		return 0;
	}
	int Vector_BindLua::Subtract(lua_State* L)
	{
		...
		chif::lua::SError(L, "Subtract(Vector v1,v2) not enough arguments!");
		return 0;
	}
	int Vector_BindLua::Lerp(lua_State* L)
	{
		...
		chif::lua::SError(L, "Lerp(Vector v1,v2, float t) not enough arguments!");
		return 0;
	}
	int Vector_BindLua::Rotate(lua_State* L)
	{
		...
		chif::lua::SError(L, "Rotate(Vector v1,quaternion) not enough arguments!");
		return 0;
	}
	...
	int Vector_BindLua::QuaternionInverse(lua_State* L)
	{
		...
		chif::lua::SError(L, "QuaternionInverse(Vector quaternion) not enough arguments!");
		return 0;
	}
	int Vector_BindLua::QuaternionMultiply(lua_State* L)
	{
		...
		chif::lua::SError(L, "QuaternionMultiply(Vector quaternion1,quaternion2) not enough arguments!");
		return 0;
	}
	int Vector_BindLua::QuaternionFromRollPitchYaw(lua_State* L)
	{
		...
		chif::lua::SError(L, "QuaternionFromRollPitchYaw(Vector rotXYZ) not enough arguments!");
		return 0;
	}
	int Vector_BindLua::QuaternionToRollPitchYaw(lua_State* L)
	{
		...
		if (argc > 0)
		{
			...
			if (v1)
			{
				XMFLOAT3 xyz = chif::math::QuaternionToRollPitchYaw(v1->data);
				Luna<Vector_BindLua>::push(L, XMFLOAT4(xyz.x, xyz.y, xyz.z, 0));
				return 1;
			}
		}
		chif::lua::SError(L, "QuaternionToRollPitchYaw(Vector quaternion) not enough arguments!");
		return 0;
	}
	int Vector_BindLua::Slerp(lua_State* L)
	{
		...
		chif::lua::SError(L, "Slerp(Vector quaternion1,quaternion2, float t) not enough arguments!");
		return 0;
	}
	int Vector_BindLua::QuaternionSlerp(lua_State* L)
	{
		...
		chif::lua::SError(L, "QuaternionSlerp(Vector quaternion1,quaternion2, float t) not enough arguments!");
		return 0;
	}
	...
	int Vector_BindLua::PlaneFromPointNormal(lua_State* L)
	{
		...
		chif::lua::SError(L, "PlaneFromPointNormal(Vector a,b,c) not enough arguments!");
		return 0;
	}
	int Vector_BindLua::PlaneFromPoints(lua_State* L)
	{
		...
		chif::lua::SError(L, "PlaneFromPoints(Vector a,b,c) not enough arguments!");
		return 0;
	}
	...
	int Vector_BindLua::GetAngle(lua_State* L)
	{
		...
		if (argc > 2)
		{
			...
			if (argc > 3)
			{
				max_value = chif::lua::SGetFloat(L, 4);
			}
			if (a && b && axis)
			{
				chif::lua::SSetFloat(L, chif::math::GetAngle(XMLoadFloat4(&a->data), XMLoadFloat4(&b->data), XMLoadFloat4(&axis->data), max_value));
				return 1;
			}
			else
			{
				chif::lua::SError(L, "GetAngle(Vector a,b,axis, opt float max) first 3 arguments are not vectors!");
			}
		}
		chif::lua::SError(L, "GetAngle(Vector a,b,axis, opt float max) not enough arguments!");
		return 0;
	}
	...
	void Vector_BindLua::Bind()
	{
		...
		{
			initialized = true;
			Luna<Vector_BindLua>::Register(chif::lua::GetLuaState());
			Luna<Vector_BindLua>::push_global(chif::lua::GetLuaState(), "vector");
		}
	}
	...
	{
		std::memcpy(this, &chif::math::IDENTITY_MATRIX, sizeof(chif::math::IDENTITY_MATRIX));
		...
		for (int i = 0; i < 4; ++i)
		{
			...
			if (argc > i * 4)
			{
				x = chif::lua::SGetFloat(L, i * 4 + 1);
				if (argc > i * 4 + 1)
				{
					y = chif::lua::SGetFloat(L, i * 4 + 2);
					if (argc > i * 4 + 2)
					{
						z = chif::lua::SGetFloat(L, i * 4 + 3);
						if (argc > i * 4 + 3)
						{
							w = chif::lua::SGetFloat(L, i * 4 + 4);
						}
					}
				}
			}
	...
	int Matrix_BindLua::RotationX(lua_State* L)
	{
		...
		if (argc > 0)
		{
			mat = XMMatrixRotationX(chif::lua::SGetFloat(L, 1));
		}
		Luna<Matrix_BindLua>::push(L, mat);
		return 1;
	}
	...
	int Matrix_BindLua::RotationY(lua_State* L)
	{
		...
		if (argc > 0)
		{
			mat = XMMatrixRotationY(chif::lua::SGetFloat(L, 1));
		}
		Luna<Matrix_BindLua>::push(L, mat);
		return 1;
	}
	...
	int Matrix_BindLua::RotationZ(lua_State* L)
	{
		...
		if (argc > 0)
		{
			mat = XMMatrixRotationZ(chif::lua::SGetFloat(L, 1));
		}
		Luna<Matrix_BindLua>::push(L, mat);
		return 1;
	}
	...
	int Matrix_BindLua::LookTo(lua_State* L)
	{
		...
		if (argc > 1)
		{
			...
			if (pos != nullptr && dir != nullptr)
			{
				...
				chif::lua::SError(L, "LookTo(Vector eye, Vector direction, opt Vector up) argument is not a Vector!");
		}
		else
			chif::lua::SError(L, "LookTo(Vector eye, Vector direction, opt Vector up) not enough arguments!");
		return 1;
	}
	...
	int Matrix_BindLua::LookAt(lua_State* L)
	{
		...
		if (argc > 1)
		{
			...
			if (dir != nullptr)
			{
				...
				chif::lua::SError(L, "LookAt(Vector eye, Vector focusPos, opt Vector up) argument is not a Vector!");
		}
		else
			chif::lua::SError(L, "LookAt(Vector eye, Vector focusPos, opt Vector up) not enough arguments!");
		return 1;
	}
	...
	int Matrix_BindLua::Multiply(lua_State* L)
	{
		...
		chif::lua::SError(L, "Multiply(Matrix m1,m2) not enough arguments!");
		return 0;
	}
	int Matrix_BindLua::Add(lua_State* L)
	{
		...
		chif::lua::SError(L, "Add(Matrix m1,m2) not enough arguments!");
		return 0;
	}
	int Matrix_BindLua::Transpose(lua_State* L)
	{
		...
		chif::lua::SError(L, "Transpose(Matrix m) not enough arguments!");
		return 0;
	}
	int Matrix_BindLua::Inverse(lua_State* L)
	{
		...
		if (argc > 0)
		{
			...
			if (m1)
			{
				...
				chif::lua::SSetFloat(L, XMVectorGetX(det));
				return 2;
			}
		}
		chif::lua::SError(L, "Inverse(Matrix m) not enough arguments!");
		return 0;
	}
	int Matrix_BindLua::GetForward(lua_State* L)
	{
		...
		if (argc > 0)
		{
			...
			if (m1)
			{
				Luna<Vector_BindLua>::push(L, chif::math::GetForward(m1->data));
				return 1;
			}
		}
		Luna<Vector_BindLua>::push(L, chif::math::GetForward(data));
		return 1;
	}
	int Matrix_BindLua::GetUp(lua_State* L)
	{
		...
		if (argc > 0)
		{
			...
			if (m1)
			{
				Luna<Vector_BindLua>::push(L, chif::math::GetUp(m1->data));
				return 1;
			}
		}
		Luna<Vector_BindLua>::push(L, chif::math::GetUp(data));
		return 1;
	}
	int Matrix_BindLua::GetRight(lua_State* L)
	{
		...
		if (argc > 0)
		{
			...
			if (m1)
			{
				Luna<Vector_BindLua>::push(L, chif::math::GetRight(m1->data));
				return 1;
			}
		}
		Luna<Vector_BindLua>::push(L, chif::math::GetRight(data));
		return 1;
	}
	...
	void Matrix_BindLua::Bind()
	{
		...
		{
			initialized = true;
			Luna<Matrix_BindLua>::Register(chif::lua::GetLuaState());
			Luna<Matrix_BindLua>::push_global(chif::lua::GetLuaState(), "matrix");
		}
	}
