#ifndef CHIF_VECTOR_REPLACEMENT
#define CHIF_VECTOR_REPLACEMENT
// This file is used to allow replacement of std::vector

#ifndef CHIF_VECTOR_TYPE
#define CHIF_VECTOR_TYPE 0
#endif // CHIF_VECTOR_TYPE

#if CHIF_VECTOR_TYPE == 1
#include <cassert>
#include <cstdint>
#include <memory>
#include <utility>
...
#if CHIF_VECTOR_TYPE == 0
	using vector = std::vector<T, A>;
#elif CHIF_VECTOR_TYPE == 1
	class vector
	{
	public:
		using value_type = T;
