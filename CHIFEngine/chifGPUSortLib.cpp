...
namespace chif::gpusortlib
{
	...
	void LoadShaders()
	{
		chif::renderer::LoadShader(ShaderStage::CS, kickoffSortCS, "gpusortlib_kickoffSortCS.cso");
		chif::renderer::LoadShader(ShaderStage::CS, sortCS, "gpusortlib_sortCS.cso");
		chif::renderer::LoadShader(ShaderStage::CS, sortInnerCS, "gpusortlib_sortInnerCS.cso");
		chif::renderer::LoadShader(ShaderStage::CS, sortStepCS, "gpusortlib_sortStepCS.cso");
	...
	void Initialize()
	{
		...
		chif::graphics::GetDevice()->CreateBuffer(&bd, nullptr, &indirectBuffer);
		...
		chif::backlog::post("chif::gpusortlib Initialized (" + std::to_string((int)std::round(timer.elapsed())) + " ms)");
	}
