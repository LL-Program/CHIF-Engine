...
namespace chif::lua
{
	...
	public:
		...
		SpriteAnim_BindLua(const chif::Sprite::Anim& anim);
	...
	{
	public:
		chif::Sprite::Anim::MovingTexAnim anim;
		...
		MovingTexAnim_BindLua(const chif::Sprite::Anim::MovingTexAnim& anim);
	...
	{
	public:
		chif::Sprite::Anim::DrawRectAnim anim;
		...
		DrawRectAnim_BindLua(const chif::Sprite::Anim::DrawRectAnim& anim);
