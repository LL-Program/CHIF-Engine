#ifndef CHIF_SHADERINTEROP_H
#define CHIF_SHADERINTEROP_H
...
static const std::string SHADER_INTEROP_PATH = chif::helper::GetCurrentPath() + "/" + chif::helper::GetDirectoryFromPath(chif::helper::GetPathRelative(chif::helper::GetCurrentPath(), std::string(__FILE__)));
