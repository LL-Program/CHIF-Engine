#ifndef CHIF_SHADERINTEROP_SURFEL_GI_H
#define CHIF_SHADERINTEROP_SURFEL_GI_H
...
static const uint SURFEL_INDIRECT_OFFSET_RAYTRACE = chif::graphics::AlignTo(SURFEL_INDIRECT_OFFSET_ITERATE + 4 * 3, IndirectDispatchArgsAlignment);
static const uint SURFEL_INDIRECT_OFFSET_INTEGRATE = chif::graphics::AlignTo(SURFEL_INDIRECT_OFFSET_RAYTRACE + 4 * 3, IndirectDispatchArgsAlignment);
...
#endif // CHIF_SHADERINTEROP_SURFEL_GI_H
