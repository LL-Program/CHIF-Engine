#ifndef CHIF_SHADERINTEROP_EMITTEDPARTICLE_H
#define CHIF_SHADERINTEROP_EMITTEDPARTICLE_H
...
static const uint ARGUMENTBUFFER_OFFSET_DRAWPARTICLES = chif::graphics::AlignTo(ARGUMENTBUFFER_OFFSET_DISPATCHSIMULATION + (3 * 4), IndirectDrawArgsAlignment);
...
#endif // CHIF_SHADERINTEROP_EMITTEDPARTICLE_H
