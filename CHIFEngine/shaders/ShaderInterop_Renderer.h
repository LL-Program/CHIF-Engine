#ifndef CHIF_SHADERINTEROP_RENDERER_H
#define CHIF_SHADERINTEROP_RENDERER_H
...
{
	uint		options;					// chif::renderer bool options packed into bitmask (OPTION_BIT_ values)
	float		time;
	float		time_previous;
	float		delta_time;
...
#endif // CHIF_SHADERINTEROP_RENDERER_H
