...
namespace chif::lua
{
	...
	SpriteAnim_BindLua::SpriteAnim_BindLua(const chif::Sprite::Anim& anim) :anim(anim)
	{
	}

	SpriteAnim_BindLua::SpriteAnim_BindLua(lua_State* L)
	{
		anim = chif::Sprite::Anim();
	}
	...
	int SpriteAnim_BindLua::SetRot(lua_State* L)
	{
		...
		if (argc > 0)
		{
			anim.rot = chif::lua::SGetFloat(L, 1);
		}
		else
		{
			chif::lua::SError(L, "SetRot(float rot) not enough arguments!");
		}
		return 0;
	}
	...
	int SpriteAnim_BindLua::SetOpacity(lua_State* L)
	{
		...
		if (argc > 0)
		{
			anim.opa = chif::lua::SGetFloat(L, 1);
		}
		else
		{
			chif::lua::SError(L, "SetOpacity(float val) not enough arguments!");
		}
		return 0;
	}
	int SpriteAnim_BindLua::SetFade(lua_State* L)
	{
		...
		if (argc > 0)
		{
			anim.fad = chif::lua::SGetFloat(L, 1);
		}
		else
		{
			chif::lua::SError(L, "SetFade(float val) not enough arguments!");
		}
		return 0;
	}
	int SpriteAnim_BindLua::SetWobbleAnimAmount(lua_State* L) 
	{
		...
		if (argc > 0)
		{
			anim.wobbleAnim.amount = XMFLOAT2(chif::lua::SGetFloat(L, 1), chif::lua::SGetFloat(L, 1));
		}
		else
		{
			chif::lua::SError(L, "SetWobbleAnimAmount(float val) not enough arguments!");
		}
		return 0;
	}
	int SpriteAnim_BindLua::SetWobbleAnimSpeed(lua_State* L) 
	{
		...
		if (argc > 0)
		{
			anim.wobbleAnim.speed = chif::lua::SGetFloat(L, 1);
		}
		else
		{
			chif::lua::SError(L, "SetWobbleAnimSpeed(float val) not enough arguments!");
		}
		return 0;
	}
	int SpriteAnim_BindLua::SetRepeatable(lua_State* L)
	{
		...
		if (argc > 0)
		{
			anim.repeatable = chif::lua::SGetBool(L, 1);
		}
		else
		{
			chif::lua::SError(L, "SetRepeatable(float val) not enough arguments!");
		}
		return 0;
	}
	int SpriteAnim_BindLua::SetVelocity(lua_State* L)
	{
		...
		if (argc > 0)
		{
			...
			{
				chif::lua::SError(L, "SetVelocity(Vector val) argument is not a Vector!");
			}
		}
		else
		{
			chif::lua::SError(L, "SetVelocity(Vector val) not enough arguments!");
		}
		return 0;
	}
	int SpriteAnim_BindLua::SetScaleX(lua_State* L)
	{
		...
		if (argc > 0)
		{
			anim.scaleX = chif::lua::SGetFloat(L, 1);
		}
		else
		{
			chif::lua::SError(L, "SetScaleX(float val) not enough arguments!");
		}
		return 0;
	}
	int SpriteAnim_BindLua::SetScaleY(lua_State* L)
	{
		...
		if (argc > 0)
		{
			anim.scaleY = chif::lua::SGetFloat(L, 1);
		}
		else
		{
			chif::lua::SError(L, "SetScaleY(float val) not enough arguments!");
		}
		return 0;
	}
	int SpriteAnim_BindLua::SetMovingTexAnim(lua_State* L)
	{
		...
		if (argc > 0)
		{
			...
			{
				chif::lua::SError(L, "SetMovingTexAnim(MovingTexAnim data) argument is not a MovingTexAnim!");
			}
		}
		else
		{
			chif::lua::SError(L, "SetMovingTexAnim(MovingTexAnim data) not enough arguments!");
		}
		return 0;
	}
	int SpriteAnim_BindLua::SetDrawRecAnim(lua_State* L)
	{
		...
		if (argc > 0)
		{
			...
			{
				chif::lua::SError(L, "SetDrawRecAnim(DrawRecAnim data) argument is not a DrawRecAnim!");
			}
		}
		else
		{
			chif::lua::SError(L, "SetDrawRecAnim(DrawRecAnim data) not enough arguments!");
		}
		return 0;
	}
	...
	{
		chif::lua::SSetFloat(L, anim.opa);
		return 1;
	}
	int SpriteAnim_BindLua::GetFade(lua_State* L)
	{
		chif::lua::SSetFloat(L, anim.fad);
		return 1;
	}
	int SpriteAnim_BindLua::GetRepeatable(lua_State* L)
	{
		chif::lua::SSetBool(L, anim.repeatable);
		return 1;
	}
	...
	{
		chif::lua::SSetFloat(L, anim.scaleX);
		return 1;
	}
	int SpriteAnim_BindLua::GetScaleY(lua_State* L)
	{
		chif::lua::SSetFloat(L, anim.scaleY);
		return 1;
	}
	...
	void SpriteAnim_BindLua::Bind()
	{
		...
		{
			initialized = true;
			Luna<SpriteAnim_BindLua>::Register(chif::lua::GetLuaState());
			Luna<MovingTexAnim_BindLua>::Register(chif::lua::GetLuaState());
			Luna<DrawRectAnim_BindLua>::Register(chif::lua::GetLuaState());
		}
	}
	...
	MovingTexAnim_BindLua::MovingTexAnim_BindLua(const chif::Sprite::Anim::MovingTexAnim& anim) :anim(anim)
	{
	}

	MovingTexAnim_BindLua::MovingTexAnim_BindLua(lua_State* L)
	{
		anim = chif::Sprite::Anim::MovingTexAnim();
		int argc = chif::lua::SGetArgCount(L);
		if (argc > 0)
		{
			anim.speedX = chif::lua::SGetFloat(L, 1);
			if (argc > 1)
			{
				anim.speedY = chif::lua::SGetFloat(L, 2);
			}
		}
	}
	...
	int MovingTexAnim_BindLua::SetSpeedX(lua_State* L)
	{
		...
		{
			chif::lua::SError(L, "SetSpeedX(float val) not enough arguments!");
		}
		return 0;
	}
	int MovingTexAnim_BindLua::SetSpeedY(lua_State* L)
	{
		...
		if (argc > 0)
		{
			anim.speedY = chif::lua::SGetFloat(L, 1);
		}
		else
		{
			chif::lua::SError(L, "SetSpeedY(float val) not enough arguments!");
		}
		return 0;
	}
	...
	{
		chif::lua::SSetFloat(L, anim.speedX);
		return 1;
	}
	int MovingTexAnim_BindLua::GetSpeedY(lua_State* L)
	{
		chif::lua::SSetFloat(L, anim.speedY);
		return 1;
	}
	...
	DrawRectAnim_BindLua::DrawRectAnim_BindLua(const chif::Sprite::Anim::DrawRectAnim& anim) :anim(anim)
	{
	}

	DrawRectAnim_BindLua::DrawRectAnim_BindLua(lua_State* L)
	{
		anim = chif::Sprite::Anim::DrawRectAnim();
	}
	...
	int DrawRectAnim_BindLua::SetFrameRate(lua_State* L)
	{
		...
		if (argc > 0)
		{
			anim.frameRate = chif::lua::SGetFloat(L, 1);
		}
		else
		{
			chif::lua::SError(L, "SetFrameRate(float val) not enough arguments!");
		}
		return 0;
	}
	int DrawRectAnim_BindLua::SetFrameCount(lua_State* L)
	{
		...
		if (argc > 0)
		{
			anim.frameCount = chif::lua::SGetInt(L, 1);
		}
		else
		{
			chif::lua::SError(L, "SetFrameCount(int val) not enough arguments!");
		}
		return 0;
	}
	int DrawRectAnim_BindLua::SetHorizontalFrameCount(lua_State* L)
	{
		...
		if (argc > 0)
		{
			anim.horizontalFrameCount = chif::lua::SGetInt(L, 1);
		}
		else
		{
			chif::lua::SError(L, "SetHorizontalFrameCount(int val) not enough arguments!");
		}
		return 0;
	}
	...
	{
		chif::lua::SSetFloat(L, anim.frameRate);
		return 1;
	}
	int DrawRectAnim_BindLua::GetFrameCount(lua_State* L)
	{
		chif::lua::SSetInt(L, anim.frameCount);
		return 1;
	}
	int DrawRectAnim_BindLua::GetHorizontalFrameCount(lua_State* L)
	{
		chif::lua::SSetInt(L, anim.horizontalFrameCount);
		return 1;
	}
