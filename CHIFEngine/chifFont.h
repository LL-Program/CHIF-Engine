...
namespace chif::font
{
	...
	struct Params
	{
		...
		chif::Color color; // base color of the text characters
		chif::Color shadowColor; // transparent disables, any other color enables shadow under text
		float h_wrap = -1; // wrap start width (-1 default for no wrap) (logical canvas units)
		int style = 0; // 0: use default font style, other values can be taken from the chif::font::AddFontStyle() funtion's return value
		...
		Params(
			...
			chif::Color color = chif::Color(255, 255, 255, 255),
			chif::Color shadowColor = chif::Color(0, 0, 0, 0)
		) :
	...
	const chif::graphics::Texture* GetAtlas();
	...
	//	in chif::font::Params::cursor
	Cursor Draw(const char* text, size_t text_length, const Params& params, chif::graphics::CommandList cmd);
	Cursor Draw(const wchar_t* text, size_t text_length, const Params& params, chif::graphics::CommandList cmd);
	Cursor Draw(const char* text, const Params& params, chif::graphics::CommandList cmd);
	Cursor Draw(const wchar_t* text, const Params& params, chif::graphics::CommandList cmd);
	Cursor Draw(const std::string& text, const Params& params, chif::graphics::CommandList cmd);
	Cursor Draw(const std::wstring& text, const Params& params, chif::graphics::CommandList cmd);
