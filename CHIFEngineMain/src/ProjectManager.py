...
from CHIFEngineMain.Common import logger, log_level
from CHIFEngineMain.Utilities import Singleton, GetClassName, Config
...
class ProjectManager(Singleton):
    ...
    def initialize(self, core_manager, project_filename=""):
        ...
        try:
            ...
            logger.info("USED PROJECT DIR %s : %s" % (GetClassName(self), self.project_dir))
