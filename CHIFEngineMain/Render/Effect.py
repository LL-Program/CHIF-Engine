...
from CHIFEngineMain.OpenGLContext import DispatchIndirectCommand, DispatchIndirectBuffer
from CHIFEngineMain.OpenGLContext import DrawElementsIndirectCommand, DrawElementIndirectBuffer
from CHIFEngineMain.OpenGLContext import ShaderStorageBuffer, InstanceBuffer, UniformBlock
from CHIFEngineMain.Utilities import *
from CHIFEngineMain.Common.Constants import *
from CHIFEngineMain.Common import logger, log_level, COMMAND
...
class Particle:
    ...
    def initialize(self):
        ...
        if self.particle_info.enable_gpu_particle:
            ...
            # CPU Particle - Will be implemented in Spe*
...
class ParticleInfo:
    def __init__(self, name, **particle_info):
        ...
        self.fade_in = particle_info.get('fade_in', 0.0)
